...
{
  "displayName": "Facebook Pixel  with consent Manager",  
  "description": "Facebook Pixel to work with consent management Tool by Suagencia.\noriginal source code by https://opensource.fb.com/ modified by Suagencia",  
  "categories": [
    "ADVERTISING",
    "ANALYTICS"
  ],
...
[
  ...
  },
  {
    ...
    "checkboxText": "Integração com Enhanced Ecommerce dataLayer",
    "simpleValueType": true,
    "help": "Caso selecionado, o Pixel do facebook irá popular o Nome then the Facebook pixel will populate \u003cstrong\u003eNome do Evento\u003c/strong\u003e e \u003cstrong\u003ePropriedades do Objeto\u003c/strong\u003e automaticamente com o ultimo  objeto de \u003ca href\u003d\"https://developers.google.com/tag-manager/enhanced-ecommerce\"\u003eecommerce\u003c/a\u003e enviado pelo Google Tag Manager (dataLayer)."
  },
  {
    "type": "RADIO",
    "name": "Nome do Evento",
    ...
    "radioItems": [
      ...
      {
        "value": "custom",
        "displayValue": "Evento Customizado",
        "subParams": [
          {
            "type": "TEXT",
  ...
  },
  {
    ...
    "radioItems": [
      {
        "value": "eec",
        "displayValue": "Definido Automaticamente pelo GTM (dataLayer)"
      }
    ],
    "simpleValueType": true,
    "help": "A Integração com o Enhanced Ecommerce preenche automaticamente o nome do evento de acordo com o objeto \u003cstrong\u003eecommerce\u003c/strong\u003e enviado por ultimo para o dataLayer (\"detail\" -\u003e \"ViewContent\", \"add\" -\u003e \"AddToCart\", \"checkout\" -\u003e \"InitiateCheckout\", \"purchase\" -\u003e \"Purchase\").",
    "enablingConditions": [
      {
        "paramName": "enhancedEcommerce",
        "paramValue": true,
  ...
  },
  {
    ...
    "checkboxText": "Habilitar FB Advanced Matching",
    "type": "CHECKBOX"
  },
  {
    "enablingConditions": [
    ...
    "displayName": "Advanced Matching - Dados do internauta",
        ...
        "simpleTableColumns": [
          {
            "selectItems": [
              ...
              {
                "displayValue": "ID Externo",
                "value": "external_id"
              },
              {
                "displayValue": "Primeiro Nome",
                "value": "fn"
              },
              {
                "displayValue": "Genero",
              ...
              {
                "displayValue": "Sobrenome",
                "value": "ln"
              },
              {
                "displayValue": "Telefone",
                "value": "ph"
              },
              {
                "displayValue": "Estado",
          ...
          {
            "defaultValue": "",
            "displayName": "Valor do Parametro",
            "name": "value",
            "type": "TEXT"
          }
        ],
        "type": "SIMPLE_TABLE",
        "newRowButtonText": "Adicionar parametro",
        "valueValidators": [
          {
            "type": "NON_EMPTY"
          }
  ...
  {
    "displayName": "Propriedades do Objeto",
    ...
    "subParams": [
      {
        ...
        "displayName": "\u003cstrong\u003eAtenção!\u003c/strong\u003e Você habilitou a Integração com o Enhanced Ecommerce, que popula automaticamente o Evento do Facebook com as propriedados do Tag Manager. Se você configurar aqui alguma dessas propriedades (content_type, contents, num_items, value, currency), elas irão substituir os dados definidos pela integração",
        "enablingConditions": [
          {
            "paramName": "enhancedEcommerce",
            "paramValue": true,
      ...
      },
      {
        ...
        "displayName": "Carregar as propriedades de uma variável",
        "macrosInSelect": true,
        "selectItems": [
          {
            "value": false,
        ...
        "simpleValueType": true,
        "help": "Você pode usar uma variável que retorna um objeto javacript com as propriedades do evento. Essas propriedades serão enviadas junto com as propriedades definidas na  tabela abaixo. Caso exista conflito, as propriedades definidas na tabela terão prioridade."
      },
      {
  ...
  {
    "displayName": "Mais Configurações",
    "name": "moreSettingsGroup",
    "groupStyle": "ZIPPY_CLOSED",
    "type": "GROUP",
    "subParams": [
      {
        "help": "Facebook coleta alguns metadados (ex: dados de estrutura) e interações de usuário (ex: clicks e submissões de formulário) automaticamente. Marque esta opção para desativar essa configuração do pixel.",
        "simpleValueType": true,
        "name": "disableAutoConfig",
        "checkboxText": "Desativar Configurações Automáticas",
        "type": "CHECKBOX"
      },
      {
        "type": "CHECKBOX",
        "name": "disablePushState",
        "checkboxText": "Desativar rastreamento do historico de navegação",
        "simpleValueType": true,
        "help": "O Facebook rastreira automaticamente mudanças no histórico de navegação (eventos pushState e replaceState) e os registra como novos PageViews. Marque essa opção para que esse rastreamento não ocorra."
      },
      {
        "type": "TEXT",
        "name": "eventId",
        "displayName": "ID do Evento (eventID)",
        "simpleValueType": true,
        "help": "Defina um ID de Evento caso esse evento também seja rastreado via servidor (server-side). O ID do evento pode ser usado para remover as duplicações de evento quando o mesmo evento é enviado de multiplos lugares. Saiba mais \u003ca href\u003d\"https://developers.facebook.com/docs/marketing-api/conversions-api/deduplicate-pixel-and-server-events/\"\u003eaqui\u003c/a\u003e."
      }
    ]
  },
  {
    "type": "SELECT",
    "name": "consent",
    "displayName": "Consentimento necessário",
    "macrosInSelect": true,
    "selectItems": [
      {
        "value": "ad_storage",
    ...
    "simpleValueType": true,
    "help": "Você deve mapear o uso do facebook tracking com um dos tipos de consentimentos apresentados pelo banner de consentimento. o facebook fará o rastreamento somente se o usuário der o consentimento para esse tipo de uso.\nVeja mais detalhes sobre o facebook e as leis \u003ca href\u003d\" \nhttps://developers.facebook.com/docs/facebook-pixel/implementation/gdpr/\"\u003eGDPR\u003c/a\u003e e \u003ca href\u003d\"https://developers.facebook.com/docs/marketing-apis/data-processing-options\"\u003e CCPA\u003c/a\u003e",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
...
const consent = isConsentGranted(data.consent) ? 'grant' : 'revoke';
addConsentListener( data.consent, (consentType, granted) => {
  const changeTo = granted ? 'grant' : 'revoke';
  const fbq = getFbq();
  log('facebook consent change to ', changeTo );
  fbq('consent', changeTo );
...
log('carregando, fb c/ consentimento');
...
const fbq = getFbq();
log('user consent to facebook tracking is',consent);
fbq('consent', consent);
if( consent == 'revoke')
  {fbq('dataProcessingOptions', ['LDU'], 0, 0 );}
else 
...
pixelIds.split(',').forEach(pixelId => {
  if (initIds.indexOf(pixelId) === -1) {
    ...
    fbq('set','agent','GTM-Suagencia-FBConsent', pixelId);
...
injectScript('https://connect.facebook.net/en_US/fbevents.js', ()=>{ log('carregado!, fb c/ consentimento');data.gtmOnSuccess();}, data.gtmOnFailure, 'fbPixel');
...
- name: Pixel IDs not set - run init process
  code: "let index = 0;\nlet count = 0;\nlet _fbq_gtm_ids;\n\nmockData.advancedMatching\
    ...
    \ 'agent set with invalid value').isEqualTo('GTM-Suagencia-FBConsent');\n    \
